...
```{r visualization demo, warning=FALSE, message='hide', comment=FALSE}
...
normalized_data <- normfluodbf::normfluodat(dat1, tnp = 3, cycles = 40, rows_used = c('A','B','C'), interval = 30, normfluodbf.verbose = FALSE)
sink(type = "message")
sink()
```
