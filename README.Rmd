...
```{r qc demo, warning=FALSE, message=FALSE, comment=FALSE}
...
```{r visualization demo, warning=FALSE, message=FALSE, comment=FALSE, include=TRUE, echo=TRUE}
...
plot <- normalized_fluo_long %>%
  ...
  theme(
    ...
    axis.title.y = element_text(family = "DejaVu Sans",margin = margin(t = 0, r = 30, b = 0, l = 0)),
    axis.title.x = element_blank(),
    axis.text = element_text(family = "DejaVu Sans",size = 8),
