...
```{r qc demo, warning=FALSE, message=FALSE, comment=FALSE, echo=FALSE, fig.path = "man/figures/"}
...
```{r visualization demo, warning=FALSE, message=FALSE, comment=FALSE, include=TRUE, echo=TRUE, fig.path = "man/figures/"}
