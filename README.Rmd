...
# `r badger::badge_custom("normfluodbf", "1.5.2", "blue", "https://github.com/AlphaPrime7/normfluodbf")` <img src="man/figures/logo.png" align="right" width="180"/>
...
For quick starters, please visit the [`{video tutorial}`](https://alphaprime7.github.io/normfluodbf/articles/video.html) for an illustration on how to effectively use the package. The video tutorial only covers DAT files based on the assumption that MOST users will be interested in using the package for DAT files.
