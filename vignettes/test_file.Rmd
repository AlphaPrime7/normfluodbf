...
-   To arrive at massive documentation like this, Microsoft Word was leveraged.
-   The idea is to take one template like this which will take a lot of word and replace the function name with MS words' replace function.
-   This helps create massive documentation for testing functions.
-   All case scenarios pass and the pride factor here is this function should yield correct column names thanks to a function called actual_cols_used().
