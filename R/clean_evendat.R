...
#' @description
#' The function takes a a dirty data frame and returns a clean data frame with the only exception being that values in the returned data frame have commas at the end
#'
